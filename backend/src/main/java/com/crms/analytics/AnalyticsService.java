...
public class AnalyticsService {
    ...
    public Map<String, Object> getDashboardData() {
        ...
        long recentReports = crimeReportRepository.findAll().stream()
                .filter(report -> report.getCreatedAt() != null && report.getCreatedAt().isAfter(thirtyDaysAgo))
                .count();
    ...
    public Map<String, Object> getCrimeTrends() {
        ...
        Map<String, Long> categoryCounts = allReports.stream()
                .collect(java.util.stream.Collectors.groupingBy(
                    report -> (report.getCategory() != null && report.getCategory().getName() != null) ? report.getCategory().getName() : "Uncategorized",
        ...
        for (int i = 0; i < 6; i++) {
            ...
            long count = allReports.stream()
                    .filter(report -> report.getCreatedAt() != null &&
                                    report.getCreatedAt().isAfter(monthStart) && 
